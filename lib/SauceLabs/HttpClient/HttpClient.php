...
namespace SauceLabs\HttpClient;

use SauceLabs\Exception\TwoFactorAuthenticationRequiredException;
use Guzzle\Http\Client as GuzzleClient;
use Guzzle\Http\ClientInterface;
use Guzzle\Http\Message\Request;
use Guzzle\Http\Message\Response;

use SauceLabs\Exception\ErrorException;
use SauceLabs\Exception\RuntimeException;
use SauceLabs\HttpClient\Listener\AuthListener;
use SauceLabs\HttpClient\Listener\ErrorListener;
use Symfony\Component\EventDispatcher\EventSubscriberInterface;

/**
 * Performs requests on SauceLabs API. API documentation should be self-explanatory.
 *
...
class HttpClient implements HttpClientInterface
{
    protected $options = array(
        'base_url'    => 'https://api.SauceLabs.com/',

        'user_agent'  => 'php-SauceLabs-api (http://SauceLabs.com/KnpLabs/php-SauceLabs-api)',
        'timeout'     => 10,
    ...
    {
        $this->headers = array(
            'Accept' => sprintf('application/vnd.SauceLabs.%s+json', $this->options['api_version']),
